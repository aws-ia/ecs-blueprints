...
locals {
  ...
  tag_val_private_subnet = var.vpc_tag_value == "" ? "${var.core_stack_name}-private-" : var.private_subnets
  tag_val_public_subnet  = var.vpc_tag_value == "" ? "${var.core_stack_name}-public-" : var.public_subnets
