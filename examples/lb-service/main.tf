...
module "ecs_service_definition" {
  ...
  scheduled_autoscaling_up__min_capacity = var.scheduled_autoscaling_up__min_capacity
  scheduled_autoscaling_up__max_capacity = var.scheduled_autoscaling_up__max_capacity
}
