...
from lib.backend_service_stack import BackendServiceStack
...
if deploy_core:
    ...
    backend_stack_props.vpc = core_stack.vpc
    backend_stack_props.ecs_cluster_name = core_stack.ecs_cluster_name
    backend_stack_props.sd_namespace = [
        ns
...
backend_service_stack = BackendServiceStack(
    ...
    backend_stack_props,
    env=Environment(
        account=backend_stack_props.account_number,
        region=backend_stack_props.aws_region,
    ),
)

backend_service_stack.validate_stack_props()
